...
<div id="subscribe">
	...
	<p><img style="vertical-align:-6px;" alt="RSS" src="<?php bloginfo('template_directory'); ?>/images/rssicon.gif" /> &nbsp;<a href="<?php bloginfo_rss('rss2_url') ?>"><?php _e('Entries RSS'); ?></a> | <a href="<?php bloginfo_rss('comments_rss2_url') ?>"><?php _e('Comments RSS'); ?></a></p>
